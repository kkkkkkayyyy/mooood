...
import tensionImg from '../assets/Tensión-02.png'
import ansiedadImg from '../assets/Ansiedad.png'
import frustracionImg from '../assets/Frustración.png'
...
const subEmotions = [
  { key: 'tension',    label: 'Tensión',    img: tensionImg,     selected: true },
  { key: 'ansiedad',   label: 'Ansiedad',   img: ansiedadImg },
  { key: 'frustracion',label: 'Frustración',img: frustracionImg },
  ...
  { key: 'verguenza',  label: 'Vergüenza',  img: verguenzaImg },
]
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden" style={{ background: '#FFFEFA' }}>
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-5 pb-4">
        <p
          className="font-quicksand font-bold text-center opacity-70 mb-8"
        ...
        <div className="grid grid-cols-3 gap-x-6 gap-y-6">
          {subEmotions.map(({ key, label, img }) => (
            <button
              ...
              className="flex flex-col items-center gap-3 card-press"
              style={{ opacity: selected === key ? 1 : 0.5 }}
            >
              ...
              <span
                ...
                style={{ fontSize: 12, color: '#272724' }}
              >
                {label}
              </span>
            </button>
